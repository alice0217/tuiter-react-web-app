...
export const findTuitsThunk = createAsyncThunk( // create thunk for findTuits
    ...
    async () => await service.findTuits() // service function. Returned data goes in redux
                                                // action's payload
    // so that the TuitList React component implemented in an earlier assignment can use the
                                                // thunks to retrieve the tuits when the
                                                // component loads.
);
